# Reinforcement Learning Algorithm-PyTorch
PyTorch implementation of different reinforcement learning algorithm for OpenAI gym environments.

## Usage

- To test a preTrained network : run `test.py` or `test_continuous.py`
- To train a new network : run `train.py` or `train_continuous.py`
- All the hyperparameters are in the `train.py` or `train_continuous.py` file
